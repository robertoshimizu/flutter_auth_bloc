...
List<PageItem> getPageItems() {
  return <PageItem>[
    PageItem('assets/images/4204968.jpg', 'Conheça melhor!',
        'EuIndico.app é um aplicativo que ajuda pessoas a receber indicações de sua rede social.'),
    PageItem('assets/images/10746.png', 'Como funciona?',
        'Você recebe uma notificação de um amigo buscando uma indicação de algum profissional.'),
